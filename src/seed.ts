...
const capacity = db.prepare(
  "INSERT OR REPLACE INTO store_format_capacity VALUES (?, ?, ?)"
);
...
console.log("");
console.log(
  "S412 aisle_barrier C5:  6 capacity, 3 confirmed, 2 held  -> 1 available"
);
console.log(
  "  (a fourth unit is held by an expired hold, which does not count)"
);
